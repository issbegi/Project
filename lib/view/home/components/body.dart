...
import 'package:urbanfootprint/view/store.dart/explore.dart';
...
class _BodyState extends State<Body> {
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        child: FadeAnimation(
                          delay: 2,
                          child: Text("\Ksh${model.price.toStringAsFixed(2)}",
  ...
  moreTextWidget() {
    return Container(
      ...
      child: Row(
        children: [
          Text("Explore our Catalogue", style: AppThemes.homeMoreText),
